...
//	public static bool b_createdSkeletonWrapper = false;
...
//		{
//			GameObject _go = null;
//			_go = FindObjectOfType(typeof(SkeletonWrapper)) as GameObject;
//			if(_go == null)
//			{
//				if(b_createdSkeletonWrapper == false)
//				{
//					b_createdSkeletonWrapper = true;
//					_go = GameObject.Instantiate(GlobalVariables.GO_KINECT_PREFAB) as GameObject;
//				}
//			}
//
//			if(_go != null)
//			{
//				_instance = _go.GetComponent<SkeletonWrapper>();
//			}
//
//			return _instance;
//		}
